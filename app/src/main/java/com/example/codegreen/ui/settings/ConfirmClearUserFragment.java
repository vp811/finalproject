...
public class ConfirmClearUserFragment extends DialogFragment {

    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setMessage("Are you sure you want to delete all of your data? This CANNOT be restored!")
                .setPositiveButton("Confirm delete", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        MainActivity mainActivity = (MainActivity) getActivity();
                        assert mainActivity != null;
                        mainActivity.getUser().clearAllData();
                        ConfirmClearUserFragment.this.getDialog().cancel();
                    }
                })
